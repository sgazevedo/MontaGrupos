...
namespace MontaGrupos
{
  class Program
  {
    static void Main(string[] args)
    {
      ...
      eurocopa.Potes[0].Inserir(new Selecao("Alemanha", EConfederacao.UEFA, 100),
      ...
      eurocopa.Potes[1].Inserir(new Selecao("Grécia", EConfederacao.UEFA, 100),
      ...
      eurocopa.Potes[2].Inserir(new Selecao("Turquia", EConfederacao.UEFA, 100),
      ...
      eurocopa.Potes[3].Inserir(new Selecao("Eslovênia", EConfederacao.UEFA, 100),
      ...
      eurocopa.SortearPote(numeroPote: 0);
